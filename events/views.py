...
MOCK_ORGANIZERS = {
    1: {
        ...
        'events': [
            {'emoji': '🚀', 'title': 'Хакатон по AI и машинному обучению', 'date': '5–7 апреля 2026'},
            {'emoji': '🎤', 'title': 'AI Meetup: Большие языковые модели', 'date': '10 февраля 2026'},
            {'emoji': '📚', 'title': 'Воркшоп: Введение в PyTorch', 'date': '18 января 2026'},
        ],
    },
}
...
DEFAULT_ORGANIZER = {
    'name': 'SPI Events',
    'emoji': '🏛️',
    'tagline': 'Организатор студенческих мероприятий',
    'desc': (
        'SPI Events — команда организаторов, которая создаёт образовательные и профессиональные '
        'мероприятия для студентов и молодых специалистов. Мы помогаем людям развиваться, '
        'находить единомышленников и строить карьеру.'
    ),
    'about': (
        'За плечами нашей команды — десятки успешно проведённых событий: от небольших митапов '
        'до масштабных конференций с участием сотен человек. Мы работаем с университетами, '
        'компаниями и студенческими сообществами по всей России.'
    ),
    'events': [
        {'emoji': '📊', 'title': 'Конференция: Data Science в бизнесе', 'date': '15 мая 2026'},
        {'emoji': '💼', 'title': 'Карьерная ярмарка — IT & Tech 2026', 'date': '19 апреля 2026'},
    ],
}


def organizer_page(request, event_id=None):
    organizer = MOCK_ORGANIZERS.get(event_id, DEFAULT_ORGANIZER)
